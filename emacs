...
(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path indium eslint-fix swiper auto-compile hl-todo magit-todos typescript-mode tramp-term tramp-theme docker-tramp company-tern js2-mode flycheck company use-package))
 '(show-paren-mode t))
(custom-set-faces
